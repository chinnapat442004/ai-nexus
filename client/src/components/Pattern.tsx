    ...
    <div className="flex flex-col gap-6">
      <div className="bg-white border border-zinc-200 rounded-2xl p-6 shadow-sm">
        ...
        <div className="text-muted-foreground text-md">
          ระบบใช้สำหรับสกัดข้อมูลจากบัตรประชาชนเท่านั้น
          ไม่มีการจัดเก็บข้อมูลลงฐานข้อมูล สามารถใช้บัตรจำลองในการทดสอบได้
        </div>
        <div className={cn('w-full max-w-4xl flex flex-col gap-4', className)}>
          <div className="w-full flex flex-col md:flex-row gap-8 items-start mt-6">
                  ...
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-muted-foreground text-xs">
                        ...
                        {formatBytes(maxSize)} ต่อไฟล์ (สูงสุด {maxFiles} ไฟล์)
                      </p>
                    </div>
            ...
            <div className="w-full md:w-1/2 pl-6  rounded-2xl bg-white  min-h-[300px]">
              <h2 className="text-lg font-semibold">ข้อมูลบัตรประชาชน</h2>
              {loading && (
          ...
          {ocrError && (
            <div className="fixed top-6 right-6 z-50 w-full max-w-sm animate-in fade-in slide-in-from-top-5 duration-300">
              <Alert
                variant="destructive"
                className="shadow-lg border-destructive/20 bg-white/85 dark:bg-zinc-950/85 backdrop-blur-md pr-10"
              >
                <CircleAlertIcon />
